      ...
      <section style={{ padding: "80px 24px", background: "var(--bg-secondary)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          >
            ...
            >
              Every contact that moves through your pipeline generates a behavioral record —
              response signals, engagement patterns, enrichment accuracy — captured, structured, and
              retained as your proprietary asset. The longer the system runs, the more precise every
              future campaign becomes.
            </p>
          </div>
        </div>
      </section>
