...
export const metadata: Metadata = {
  ...
  description:
    "Outbound pipeline design, contact scoring, and custom AI engineering. Three-phase service model: Design & Execution, Data Intelligence, The AI Moat. Built for M&A advisors, business brokers, and PE deal teams.",
};
  ...
  "@graph": [
    {
      ...
      description:
        "ICP design, cohort architecture, data hygiene, and sequence execution for M&A advisors, business brokers, and PE deal teams. LinkedIn-led campaigns reach 700–5,000 contacts per month depending on tier, producing a 17%+ reply rate and 12.6% acceptance rate for meeting requests.",
    ...
    },
    {
      ...
      description:
        "Predictive lead scoring, market intelligence reports, and content infrastructure built on behavioral data from active outbound campaigns. Turns campaign signal into a proprietary intelligence asset.",
      areaServed: "United States",
    },
    {
      "@type": "Service",
      ...
      description:
        "A $750 diagnostic of your current outbound infrastructure, ICP fit, and data quality — the entry point before any retainer commitment.",
      areaServed: "United States",
      offers: {
        "@type": "Offer",
        price: "750",
    ...
    },
    {
      ...
      description:
        "Predictive contact scoring, cohort ranking, and market intelligence built on behavioral campaign data. Turn signal into a proprietary asset that improves with every batch.",
      areaServed: "United States",
      offers: {
        "@type": "AggregateOffer",
        lowPrice: "750",
    ...
    tiers: [
      {
        ...
        price: "$1,500/mo",
        seats: "1 seat (Foundation) / +$800 per additional",
        contacts: "700 contacts/month per seat",
        note: "",
      },
      {
        name: "Email Outreach",
        price: "+$1,000/mo",
        seats: "1 seat (Email) / +$600 per additional",
      ...
      },
      {
        ...
        price: "$750–$2,500",
        seats: "Service-specific",
        contacts: "Pipeline Audit ($750 flat) or Engine Optimization ($750–$2,500/mo)",
        note: "Pipeline Audit: infrastructure assessment, ICP analysis, recommendations. Engine Optimization: AEO/SEO audit, LLM configuration, JSON-LD schema, AI citation strategy.",
      },
    ],
  },
  {
    ...
    <>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <p style={{ fontSize: 16, color: "var(--text-muted)" }}>
              Four operator verticals. One infrastructure problem.
            </p>
          </div>
          <div
            style={{
              ...
              >
                <div
                  style={{
                    fontSize: 15,
                    fontWeight: 700,
                    color: col.accent ? "var(--accent-blue)" : "var(--text-muted)",
                    marginBottom: 24,
                    letterSpacing: "0.02em",
                  }}
                >
                ...
                >
                  {col.items.map((item) => (
                    ...
                    >
                      <span style={{ color: col.iconColor, fontWeight: 700, flexShrink: 0 }}>
                        {col.icon}
                      </span>
                      {item}
                    </li>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              >
                A diagnostic of your current outbound infrastructure, ICP fit, and data quality.
                Written assessment with specific recommendations — before any retainer commitment.
              </p>
              <ul
                style={{
                  listStyle: "none",
              ...
              >
                {[
                  ...
                  <li
                    key={item}
                    style={{ display: "flex", gap: 10, fontSize: 14, color: "var(--text-muted)" }}
                  >
            ...
            >
              ...
              >
                SEO, GEO, and AEO audit and optimization — structured so your site gets cited by AI
                tools (ChatGPT, Perplexity, Google AI Overviews) when your prospects are
                researching. Built for B2B service businesses.
              </p>
              <ul
                style={{
                  listStyle: "none",
              ...
              >
                {[
                  "Technical SEO audit",
                  "LLM crawler configuration (robots.txt, llms.txt)",
                  "JSON-LD schema implementation (Organization, Service, FAQPage)",
                  "AI citation gap analysis",
                  "Off-site citation strategy",
                ].map((item) => (
                  <li
                    key={item}
                    style={{ display: "flex", gap: 10, fontSize: 14, color: "var(--text-muted)" }}
      ...
      <section style={{ padding: "80px 24px", background: "var(--bg)", textAlign: "center" }}>
        <div style={{ maxWidth: 520, margin: "0 auto" }}>
          ...
          >
            One conversation is enough to know whether what we build is the right fit for your
            pipeline.
          </p>
          <Link
            href="/contact"
